	...
	<div class="list-group">
		...
		<?php 
				...
				while ($list = mysqli_fetch_assoc($r)) {
					...
					//$blurb = substr(strip_tags($page_list['page_body']), 0, 160);
	...
	<div  class="col-md-10">
		...
		<form action="index.php?page=users&id=<?php echo $opened['id']; ?>" method="post" role="form">
			...
			<div class="form-group">
				...
				<label for="subdivision_name">Sub-Division Name:</label>
				<input class="form-control" type="text" name="subdivision_name" id="subdivision_name"  value="<?php echo $opened['subdivision_name']; ?>" placeholder="Sub Division" autocomplete="off">
			...
			<div class="form-group">
				...
				<select class="form-control" name="role" id="role"> 
					<option value="Operator" <?php if (isset($_GET['id'])) { selected('Operator', $opened['role'],'selected');} ?> >Operator</option>
					<option value="Admin" <?php if (isset($_GET['id'])) { selected('Admin', $opened['role'],'selected');} ?>>Admin</option> 
