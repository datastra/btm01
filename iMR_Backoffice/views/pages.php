		...
		<a class="list-group-item" href="?page=pages">
			...
			<?php 
				...
				while($list = mysqli_fetch_assoc($r)) { 
					...
					$blurb = substr(strip_tags($list['page_body']), 0, 160);
	...
	<div class="col-md-9">
		...
		<form action="index.php?page=pages&id=<?php echo $opened['id']; ?>" method="post" role="form">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="slug" id="label" value="<?php echo $opened['slug']; ?>" placeholder="Page Slug">
			...
			<div class="form-group">
				...
				<textarea class="form-control editor"  name="body" id="body" row="8" placeholder="Page Body"><?php echo $opened['page_body']; ?></textarea>
